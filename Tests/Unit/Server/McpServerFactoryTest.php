        ...
        $container->method('get')->willReturnCallback(
            static function (string $id) use ($recordService, $dataHandlerService, $fileService, $tcaSchemaService, $siteLanguageService, $cacheService, $backendLayoutService, $siteFinder, $typo3Version, $logger): object {
                return match (true) {
                    ...
                    str_contains($id, 'CopyTool') || str_contains($id, 'FileReferenceRemoveTool') => new ($id)($dataHandlerService, $logger),
                    str_contains($id, 'FileReferenceListTool') => new ($id)($recordService, $tcaSchemaService, $logger),
