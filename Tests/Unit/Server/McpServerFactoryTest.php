...
final class McpServerFactoryTest extends TestCase
{
    ...
    public function testCreateReturnsServerInstance(): void
    {
        ...
        $tools = [
            ...
            new PagesDeleteTool($dataHandlerService, $recordService),
            ...
            new ContentDeleteTool($dataHandlerService, $recordService),
        ...
        $resources = [
            ...
            new TcaTableSchemaResource($tcaSchemaService, $this->createStub(PermissionService::class)),
